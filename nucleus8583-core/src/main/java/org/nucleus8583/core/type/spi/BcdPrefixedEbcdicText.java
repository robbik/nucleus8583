...
public class BcdPrefixedEbcdicText implements Type<String>, Serializer<String> {
    ...
    protected BcdPrefixedEbcdicText(Builder b) {
    ...
    @Override
    public BcdPrefixedEbcdicText serializer() {
        return this;
    }
	...
	public static class Builder implements TypeBuilder<String> {
        ...
        public Class<? extends Type<String>> getObjectClass() {
            return BcdPrefixedEbcdicText.class;
        }
        ...
        @Override
        public BcdPrefixedEbcdicText build() {
            validateAll();
