...
public class LiteralBinary implements Type<byte[]>, Serializer<byte[]> {

	protected final LiteralBinaryPadder padder;

    protected final int length;

	protected LiteralBinary(Builder b) {
    ...
    @Override
    public LiteralBinary serializer() {
        return this;
    }
	...
	public static class Builder implements TypeBuilder<byte[]> {
        ...
        public Builder withPadWith(String value) {
            if ((value == null) || value.isEmpty()) {
                ...
                padWith = StringHelper.escapeJava(value).getBytes(StandardCharsets.UTF_8)[0];
            }
            return this;
        }
        ...
        public Builder withEmptyValue(String value) {
            if ((value == null) || value.isEmpty()) {
                ...
                emptyValue = StringHelper.escapeJava(value).getBytes(StandardCharsets.UTF_8);
            }
            return this;
        }
