...
public class AsciiPrefixedLiteralBinary implements Type<byte[]>, Serializer<byte[]> {
	...
	protected AsciiPrefixedLiteralBinary(Builder b) {
	...
	@Override
	public AsciiPrefixedLiteralBinary serializer() {
		return this;
	}
	...
	public static class Builder implements TypeBuilder<byte[]> {
		...
		public Class<? extends Type<byte[]>> getObjectClass() {
			return AsciiPrefixedLiteralBinary.class;
		}
		...
		@Override
		public AsciiPrefixedLiteralBinary build() {
			validateAll();
