...
public class EbcdicAmount implements Type<String>, Serializer<String> {

    protected final EbcdicPadder padder;

    protected final int length;

    protected EbcdicAmount(Builder b) {
	...
	@Override
	public EbcdicAmount serializer() {
		return this;
	}
