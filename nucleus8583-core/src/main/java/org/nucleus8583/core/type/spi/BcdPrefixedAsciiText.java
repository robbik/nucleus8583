...
public class BcdPrefixedAsciiText implements Type<String>, Serializer<String> {
    ...
    protected BcdPrefixedAsciiText(Builder b) {
    ...
    @Override
    public BcdPrefixedAsciiText serializer() {
        return this;
    }
    ...
    public static class Builder implements TypeBuilder<String> {
        ...
        public Class<? extends Type<String>> getObjectClass() {
            return BcdPrefixedAsciiText.class;
        }
        ...
        @Override
        public BcdPrefixedAsciiText build() {
            validateAll();
