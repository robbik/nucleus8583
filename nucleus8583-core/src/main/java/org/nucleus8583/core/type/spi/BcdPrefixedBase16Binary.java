...
public class BcdPrefixedBase16Binary implements Type<byte[]>, Serializer<byte[]> {
    ...
    protected BcdPrefixedBase16Binary(Builder b) {
    ...
    @Override
    public BcdPrefixedBase16Binary serializer() {
        return this;
    }
    ...
    public static class Builder implements TypeBuilder<byte[]> {
        ...
        public Class<? extends Type<byte[]>> getObjectClass() {
            return BcdPrefixedBase16Binary.class;
        }
        ...
        @Override
        public BcdPrefixedBase16Binary build() {
