...
public class BcdAmount implements Type<String>, Serializer<String> {

	protected final BcdPadder padder;

	protected final int length;

	protected BcdAmount(Builder b) {
	...
	public static class Builder implements TypeBuilder<String> {
		...
		public Builder() {
			...
			alignment = Alignment.UNTRIMMED_RIGHT;
			padWith = '0';
		...
		public Builder withAlignment(Alignment value) {
			if (value == null) {
				value = Alignment.UNTRIMMED_RIGHT;
			}
