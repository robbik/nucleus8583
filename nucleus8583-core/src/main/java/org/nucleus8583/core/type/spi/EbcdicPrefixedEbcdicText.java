...
public class EbcdicPrefixedEbcdicText implements Type<String>, Serializer<String> {
    ...
    protected EbcdicPrefixedEbcdicText(Builder b) {
    ...
    @Override
    public EbcdicPrefixedEbcdicText serializer() {
        return this;
    }
	...
	public static class Builder implements TypeBuilder<String> {
        ...
        public Class<? extends Type<String>> getObjectClass() {
            return EbcdicPrefixedEbcdicText.class;
        }
        ...
        @Override
        public EbcdicPrefixedEbcdicText build() {
            validateAll();

            return new EbcdicPrefixedEbcdicText(this);
        }
