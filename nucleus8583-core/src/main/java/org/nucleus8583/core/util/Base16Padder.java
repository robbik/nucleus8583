...
public class Base16Padder {
	...
	public void pad(OutputStream out, byte[] value, int off, int vlen) throws IOException {
		if (vlen == 0) {
	 ...
	 * @throws IOException
	 */
	public void read(InputStream in, byte[] value, int off, int vlen) throws IOException {
		vlen <<= 1;
	 ...
	 * @throws IOException
	 */
	public void write(OutputStream out, byte[] value, int off, int vlen) throws IOException {
