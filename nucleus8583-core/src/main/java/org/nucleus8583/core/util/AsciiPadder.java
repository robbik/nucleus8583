...
public class AsciiPadder {
	...
	public AsciiPadder(AsciiPadder o) {
		padWith = o.padWith;
		align = o.align;
	...
	public void pad(OutputStream out, String value, int valueLength) throws IOException {
		if (valueLength == 0) {
	...
	public void read(InputStream in, char[] cbuf, int off, int len) throws IOException {
