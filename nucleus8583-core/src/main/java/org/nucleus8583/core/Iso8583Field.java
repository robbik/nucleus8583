...
public abstract class Iso8583Field implements Serializable {
	...
	public abstract void pack(Writer writer, BitSet value, int length) throws IOException;

	public abstract void unpackBinary(Reader reader, BitSet bits) throws IOException;
	
	public abstract void unpackBinary(Reader reader, BitSet bits, int off, int length) throws IOException;
