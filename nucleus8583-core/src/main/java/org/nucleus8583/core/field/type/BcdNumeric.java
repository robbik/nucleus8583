...
public class BcdNumeric extends FieldType {
    ...
    public BcdNumeric(FieldDefinition def, FieldAlignments defaultAlign, String defaultPadWith, String defaultEmptyValue) {
    ...
    public void write(OutputStream out, String value) throws IOException {
        ...
        if (vlen > length) {
            throw new IllegalArgumentException("value of field #" + id + " is too long, expected " + length
                    + " but actual is " + vlen);
        }
