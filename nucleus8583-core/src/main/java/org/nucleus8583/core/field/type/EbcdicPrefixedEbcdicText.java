...
public abstract class EbcdicPrefixedEbcdicText extends FieldType {
    private static final long serialVersionUID = -5615324004502124085L;

    private EbcdicPrefixer prefixer;
    ...
    public EbcdicPrefixedEbcdicText(FieldDefinition def, FieldAlignments defaultAlign, String defaultPadWith,
        ...
        prefixer = new EbcdicPrefixer(prefixLength);
