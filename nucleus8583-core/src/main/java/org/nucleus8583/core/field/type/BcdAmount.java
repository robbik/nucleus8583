...
public class BcdAmount extends FieldType {
    ...
    public BcdAmount(FieldDefinition def, FieldAlignments defaultAlign, String defaultPadWith, String defaultEmptyValue) {
