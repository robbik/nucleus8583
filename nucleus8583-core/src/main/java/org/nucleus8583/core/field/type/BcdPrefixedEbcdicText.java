...
public abstract class BcdPrefixedEbcdicText extends FieldType {
    ...
    public BcdPrefixedEbcdicText(FieldDefinition def, FieldAlignments defaultAlign, String defaultPadWith,
