...
public abstract class BcdPrefixedBase16Binary extends FieldType {
    ...
    public BcdPrefixedBase16Binary(FieldDefinition def, FieldAlignments defaultAlign, String defaultPadWith,
    ...
    public void setEmptyValue(String emptyValue) {
        ...
        for (int i = 0, j = 0; i < this.emptyValue.length; ++i, j += 2) {
            this.emptyValue[i] = (byte) ((Base16Padder.hex2int(emptyValue.charAt(j)) << 4) | Base16Padder
                    .hex2int(emptyValue.charAt(j + 1)));
        }
    }
