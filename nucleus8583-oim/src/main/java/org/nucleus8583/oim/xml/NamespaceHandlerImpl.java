...
public class NamespaceHandlerImpl extends NamespaceHandlerSupport {
	...
	public void init() {
		...
		registerObjectDefinitionParser(
				SimpleTypeDefinitionParser.ELEMENT_LOCAL_NAME,
				new SimpleTypeDefinitionParser());

		registerObjectDefinitionParser(
				ComplexTypeDefinitionParser.ELEMENT_LOCAL_NAME,
				new ComplexTypeDefinitionParser());
