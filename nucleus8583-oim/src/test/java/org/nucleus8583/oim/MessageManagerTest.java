...
public class MessageManagerTest {
	...
	public void testWrite() throws Exception {
		...
		for (int i = 0; i < runs; ++i) {
			manager.write(isoMsg, "msg1", map1);
		}
		
		System.out.println("write speed: " + ((long) runs * 1000L / (System.currentTimeMillis() - start)));
	...
	public void testRead() throws Exception {
		...
		for (int i = 0; i < runs; ++i) {
			map = (Map<String, Object>) manager.read(isoMsg1, "msg1_rev");
		}
		
		System.out.println("read speed: " + ((long) runs * 1000L / (System.currentTimeMillis() - start)));
